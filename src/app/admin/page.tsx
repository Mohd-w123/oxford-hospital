  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-slate-950 p-6 rounded-3xl border border-slate-800">
        <div>
          <span className="text-xs font-bold text-sky-400 uppercase tracking-wider">Hospital Overview</span>
        ...
        <div className="flex items-center gap-3">
          <Link
            ...
            className="bg-gradient-to-r from-[#000066] to-blue-700 hover:from-blue-950 hover:to-blue-800 text-white text-xs sm:text-sm font-bold px-4 py-2.5 rounded-xl shadow transition flex items-center gap-1.5 border border-blue-500/20"
          >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        ...
        <Link
          href="/admin/appointments"
          className="bg-slate-950 p-5 rounded-2xl border border-slate-800 hover:border-blue-500/50 transition group"
        >
          ...
          <p className="text-[11px] text-slate-500 mt-2 group-hover:text-sky-400 transition">View patient requests &rarr;</p>
        </Link>
      ...
      <div className="bg-slate-950 p-6 rounded-3xl border border-slate-800 space-y-4">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <Link
            href="/admin/slider"
            className="bg-slate-900 hover:bg-slate-800 text-sky-300 border border-blue-500/40 text-xs font-bold px-4 py-2.5 rounded-xl flex items-center gap-2 transition"
          >
                ...
                appointments.slice(0, 5).map((apt) => (
                  <tr key={apt.id} className="hover:bg-slate-900/50 transition">
                    ...
                    <td className="px-6 py-4">
                      ...
                      <p className="text-xs text-sky-400 font-semibold">{apt.preferredTime}</p>
                    </td>
