...
export default function Footer({ hospital }: FooterProps) {
  ...
  return (
    <footer className="bg-slate-950 text-slate-300 border-t border-slate-800">
      ...
      <div className="bg-gradient-to-r from-[#000066] via-slate-950 to-blue-950 py-8 border-b border-blue-900/40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
            
            <div className="flex items-center gap-4 bg-slate-900/80 p-4 rounded-2xl border border-blue-800/40 shadow-sm">
              <div className="w-12 h-12 rounded-xl bg-blue-500/10 flex items-center justify-center text-sky-400 shrink-0 border border-blue-500/20">
                <Clock className="w-6 h-6" />
              </div>
              <div>
                <p className="text-xs text-sky-300 font-semibold uppercase tracking-wider">OPD Consultation Hours</p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-xl font-extrabold text-white tracking-tight leading-none">
                  OXFORD <span className="text-sky-400">HOSPITAL</span>
                </h3>
                <p className="text-xs text-slate-400 font-medium mt-1">
                  {hospital.tagline || 'Multi-Speciality & Critical Care'}
                </p>
              </div>
            </div>
            ...
            <div className="pt-2">
              <div className="flex items-center gap-2 text-xs text-sky-300 font-semibold bg-blue-950/80 border border-blue-800/40 px-3 py-1.5 rounded-lg w-fit shadow-2xs">
                <ShieldCheck className="w-4 h-4 text-sky-400" />
                <span>13+ Speciality Doctor Panel & 24x7 Critical Care</span>
              </div>
            </div>
          </div>
          ...
          <div>
            <h4 className="text-base font-bold text-white mb-4 border-l-4 border-blue-500 pl-3">Specialist Departments</h4>
            <ul className="space-y-2.5 text-sm">
              <li>
                <Link href="/doctors" className="hover:text-sky-300 transition flex items-center gap-1.5">
                  <ChevronRight className="w-4 h-4 text-sky-400" />
                  <span>General Medicine & Physician</span>
                </Link>
              </li>
              <li>
                <Link href="/doctors" className="hover:text-sky-300 transition flex items-center gap-1.5">
              ...
              <li>
                <Link href="/doctors" className="hover:text-sky-300 transition flex items-center gap-1.5">
                  <ChevronRight className="w-4 h-4 text-sky-400" />
                  <span>Paediatrics & Neonatology</span>
                </Link>
              </li>
              <li>
                <Link href="/doctors" className="hover:text-sky-300 transition flex items-center gap-1.5">
                  <ChevronRight className="w-4 h-4 text-sky-400" />
                  <span>Cardiology & Urology Care</span>
                </Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            <h4 className="text-base font-bold text-white mb-4 border-l-4 border-blue-500 pl-3">Hospital Facilities</h4>
            <ul className="space-y-2.5 text-sm">
              <li>
                <Link href="/facilities" className="hover:text-sky-300 transition flex items-center gap-1.5">
                  <ChevronRight className="w-4 h-4 text-sky-400" />
              ...
              <li>
                <Link href="/gallery" className="hover:text-sky-300 transition flex items-center gap-1.5">
                  <ChevronRight className="w-4 h-4 text-sky-400" />
                  <span>Hospital Photo Gallery</span>
                </Link>
              </li>
              <li>
                <Link href="/appointment" className="hover:text-sky-300 transition flex items-center gap-1.5">
                  <ChevronRight className="w-4 h-4 text-sky-400" />
          ...
          <div>
            <h4 className="text-base font-bold text-white mb-4 border-l-4 border-blue-500 pl-3">Contact & Location</h4>
            <div className="space-y-3.5 text-sm">
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-0.5">
                    {hospital.phoneNumbers.map((phone) => (
                      <a key={phone} href={`tel:${phone}`} className="font-semibold text-white hover:text-sky-300">
                        {phone}
                      </a>
                    ))}
                  </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href={`mailto:${hospital.email}`} className="font-medium text-white hover:text-sky-300 break-all">
                    {hospital.email}
                  </a>
                </div>
              </div>
        ...
        <div className="mt-12 pt-8 border-t border-slate-800/80 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          ...
          <div className="flex items-center gap-4">
            ...
            <span>•</span>
            <Link href="/admin" className="text-sky-400 hover:text-sky-300 font-semibold flex items-center gap-1">
